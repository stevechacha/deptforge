...
function BrandMark() {
  return (
    <svg className="h-[26px] w-[26px] shrink-0 text-copper-bright" viewBox="0 0 24 24" fill="none">
      <rect x="1" y="1" width="22" height="22" stroke="currentColor" strokeWidth="1.3" />
      <circle cx="12" cy="12" r="3.2" fill="currentColor" />
      <line x1="12" y1="1" x2="12" y2="8.5" stroke="currentColor" strokeWidth="1.3" />
      <line x1="12" y1="15.5" x2="12" y2="23" stroke="currentColor" strokeWidth="1.3" />
      <line x1="1" y1="12" x2="8.5" y2="12" stroke="currentColor" strokeWidth="1.3" />
      <line x1="15.5" y1="12" x2="23" y2="12" stroke="currentColor" strokeWidth="1.3" />
    </svg>
  )
}
...
export function Header() {
  ...
  return (
    <header className="site-header sticky top-0 z-50 border-b border-border backdrop-blur-[8px]">
